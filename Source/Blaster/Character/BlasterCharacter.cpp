...
void ABlasterCharacter::Turn(const FInputActionValue& inputValue)
{
...
void ABlasterCharacter::Move(const FInputActionValue& inputValue)
{
    FVector2D value = inputValue.Get<FVector2D>();
    // 상하 입력 처리
    Direction.X = value.X;
...
void ABlasterCharacter::InputJump(const FInputActionValue& inputValue)
{
    Jump();
}

void ABlasterCharacter::PlayerMove()
{
